...
economic_data = calculate_mom_change(economic_data, 'technology_capital_spending', ratio=False)
economic_data = calculate_mom_change(economic_data, 'crude_oil_prices', ratio=False)
economic_data = calculate_mom_change(economic_data, 'semiconductor_shipments', ratio=False)
