...
economic_data = calculate_mom_change(economic_data, 'delinquency_rate', ratio=True)
economic_data = calculate_mom_change(economic_data, 'personal_savings_rate', ratio=True)
...
economic_data = calculate_mom_change(economic_data, 'revolving_credit', ratio=False)
