...
economic_data = calculate_mom_change(economic_data, 'corporate_bond_spread', ratio=True)
...
economic_data = calculate_mom_change(economic_data, 'stock_market_volatility', ratio=True)
...
economic_data = calculate_mom_change(economic_data, 'commercial_loans', ratio=False)
