...
economic_data = calculate_mom_change(economic_data, 'vehicle_sales', ratio=True)
...
economic_data = calculate_mom_change(economic_data, 'consumer_spending', ratio=False)
economic_data = calculate_mom_change(economic_data, 'retail_sales_vehicles', ratio=False)
